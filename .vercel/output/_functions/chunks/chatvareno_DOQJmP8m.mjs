...
const $$Chatvareno = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "FrameLayout", $$FrameLayout, { "iframeSrc": `${base}/`, "label": product.name, "title": product.seo.vi.title, "description": product.seo.vi.description, "lang": "vi" })}`;
}, "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/chatvareno.astro", void 0);

const $$file = "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/chatvareno.astro";
const $$url = "/chatvareno";
