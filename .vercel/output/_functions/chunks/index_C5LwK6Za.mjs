...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const seo = {
    ...
    description: "VarenoAI xây dựng các sản phẩm AI cho doanh nghiệp Việt: ChatVareno tư vấn & bán hàng tự động, ContentAI sản xuất nội dung."
  };
  let posts = [];
  try {
  ...
  })) })} ${renderComponent($$result2, "NewsSection", $$NewsSection, { "title": HOME.news.title[lang], "subtitle": HOME.news.subtitle[lang], "posts": posts, "basePath": "/blog", "viewAllHref": translatePath(NAV.news), "viewAllLabel": HOME.news.viewAll[lang], "emptyText": HOME.news.empty[lang] })} ${renderComponent($$result2, "CtaBand", $$CtaBand, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} </div> ` })}`;
}, "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/index.astro", void 0);

const $$file = "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/index.astro";
const $$url = "";
