...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": seoData.title, "description": seoData.description, "seo": seoData, "lang": "en" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${maybeRenderHead()}<main class="pt-32 pb-24 min-h-screen border-t border-border/40"> <article class="container max-w-[800px] mx-auto px-4 md:px-8"> <h1 class="font-display text-4xl md:text-5xl font-bold tracking-tight mb-12 text-center md:text-left text-foreground"> ${page.title} </h1> <div class="prose prose-lg dark:prose-invert max-w-none 
...
}, "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/en/legal/[slug].astro", void 0);

const $$file = "D:/DavidIT/VarenoAI/layoutchatvareno/varenoai-frontend/src/pages/en/legal/[slug].astro";
const $$url = "/en/legal/[slug]";
